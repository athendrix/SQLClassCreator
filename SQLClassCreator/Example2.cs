...
namespace ExampleNamespace.SomeSubNamespace
{
    ...
    public record Example2Record(Guid ID, Guid ID2, Guid ID3, Guid ID4, bool Data1, bool? Data2, byte Data3, byte? Data4, char Data5, char? Data6, short Data7, short? Data8, int Data9, int? Data10, long Data11, long? Data12, ulong Data13, ulong? Data14, float Data15, float? Data16, double Data17, double? Data18, decimal Data19, decimal? Data20, string Data21, string Data22, byte[] Data23, byte[] Data24, Guid Data25, Guid? Data26, DateTime Data27, DateTime? Data28, Data29 Data29, Data30? Data30) : IDBSet<Guid, Guid, Guid, Guid>
    {
        ...
        {
            Guid ID = dr.IsDBNull(0) ? default : (Guid)dr[0];
            Guid ID2 = dr.IsDBNull(1) ? default : (Guid)dr[1];
            Guid ID3 = dr.IsDBNull(2) ? default : (Guid)dr[2];
            Guid ID4 = dr.IsDBNull(3) ? default : (Guid)dr[3];
            bool Data1 = dr.IsDBNull(4) ? default : (bool)dr[4];
            bool? Data2 = dr.IsDBNull(5) ? default : (bool)dr[5];
            byte[] _Data3 = dr.IsDBNull(6) ? default : (byte[])dr[6];
            byte Data3 = _Data3[0];
            byte[] _Data4 = dr.IsDBNull(7) ? default : (byte[])dr[7];
            byte? Data4 = _Data4 == null ? default : _Data4[0];
            char Data5 = dr.IsDBNull(8) ? default : (char)dr[8];
            char? Data6 = dr.IsDBNull(9) ? default : (char)dr[9];
            short Data7 = dr.IsDBNull(10) ? default : (short)dr[10];
            short? Data8 = dr.IsDBNull(11) ? default : (short)dr[11];
            int Data9 = dr.IsDBNull(12) ? default : (int)dr[12];
            int? Data10 = dr.IsDBNull(13) ? default : (int)dr[13];
            long Data11 = dr.IsDBNull(14) ? default : (long)dr[14];
            long? Data12 = dr.IsDBNull(15) ? default : (long)dr[15];
            long _Data13 = dr.IsDBNull(16) ? default : (long)dr[16];
            ulong Data13 = (ulong)_Data13;
            long? _Data14 = dr.IsDBNull(17) ? default : (long)dr[17];
            ulong? Data14 = _Data14 == null ? default : (ulong?)_Data14;
            float Data15 = dr.IsDBNull(18) ? default : (float)dr[18];
            float? Data16 = dr.IsDBNull(19) ? default : (float)dr[19];
            double Data17 = dr.IsDBNull(20) ? default : (double)dr[20];
            double? Data18 = dr.IsDBNull(21) ? default : (double)dr[21];
            decimal Data19 = dr.IsDBNull(22) ? default : (decimal)dr[22];
            decimal? Data20 = dr.IsDBNull(23) ? default : (decimal)dr[23];
            string Data21 = dr.IsDBNull(24) ? default : (string)dr[24];
            string Data22 = dr.IsDBNull(25) ? default : (string)dr[25];
            byte[] Data23 = dr.IsDBNull(26) ? default : (byte[])dr[26];
            byte[] Data24 = dr.IsDBNull(27) ? default : (byte[])dr[27];
            Guid Data25 = dr.IsDBNull(28) ? default : (Guid)dr[28];
            Guid? Data26 = dr.IsDBNull(29) ? default : (Guid)dr[29];
            DateTime Data27 = dr.IsDBNull(30) ? default : (DateTime)dr[30];
            DateTime? Data28 = dr.IsDBNull(31) ? default : (DateTime)dr[31];
            long _Data29 = dr.IsDBNull(32) ? default : (long)dr[32];
            Data29 Data29 = (Data29)_Data29;
            long? _Data30 = dr.IsDBNull(33) ? default : (long)dr[33];
            Data30? Data30 = _Data30 == null ? default : (Data30?)_Data30;
        ...
        public object[] ToArray()
        {
            ...
            char _Data5 = Data5;
            char? _Data6 = Data6 == null ? default : Data6;
            short _Data7 = Data7;
