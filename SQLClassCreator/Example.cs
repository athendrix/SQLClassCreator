...
namespace ExampleNamespace.SomeSubNamespace
{
    ...
    public record ExampleRecord(Guid ID, bool Data1, bool? Data2, byte Data3, byte? Data4, char Data5, char? Data6, short Data7, short? Data8, int Data9, int? Data10, long Data11, long? Data12, ulong Data13, ulong? Data14, float Data15, float? Data16, double Data17, double? Data18, decimal Data19, decimal? Data20, string Data21, string Data22, byte[] Data23, byte[] Data24, Guid Data25, Guid? Data26, DateTime Data27, DateTime? Data28, Data29 Data29, Data30? Data30) : IDBSet<Guid>
    {
        ...
        public static ExampleRecord FromDataReader(IDataReader dr)
        {
            ...
            bool Data1 = dr.IsDBNull(1) ? default : (bool)dr[1];
            bool? Data2 = dr.IsDBNull(2) ? default : (bool)dr[2];
            byte[] _Data3 = dr.IsDBNull(3) ? default : (byte[])dr[3];
            byte Data3 = _Data3[0];
            byte[] _Data4 = dr.IsDBNull(4) ? default : (byte[])dr[4];
            byte? Data4 = _Data4 == null ? default : _Data4[0];
            char Data5 = dr.IsDBNull(5) ? default : (char)dr[5];
            char? Data6 = dr.IsDBNull(6) ? default : (char)dr[6];
            short Data7 = dr.IsDBNull(7) ? default : (short)dr[7];
            short? Data8 = dr.IsDBNull(8) ? default : (short)dr[8];
            int Data9 = dr.IsDBNull(9) ? default : (int)dr[9];
            int? Data10 = dr.IsDBNull(10) ? default : (int)dr[10];
            long Data11 = dr.IsDBNull(11) ? default : (long)dr[11];
            long? Data12 = dr.IsDBNull(12) ? default : (long)dr[12];
            long _Data13 = dr.IsDBNull(13) ? default : (long)dr[13];
            ulong Data13 = (ulong)_Data13;
            long? _Data14 = dr.IsDBNull(14) ? default : (long)dr[14];
            ulong? Data14 = _Data14 == null ? default : (ulong?)_Data14;
            float Data15 = dr.IsDBNull(15) ? default : (float)dr[15];
            float? Data16 = dr.IsDBNull(16) ? default : (float)dr[16];
            double Data17 = dr.IsDBNull(17) ? default : (double)dr[17];
            double? Data18 = dr.IsDBNull(18) ? default : (double)dr[18];
            decimal Data19 = dr.IsDBNull(19) ? default : (decimal)dr[19];
            decimal? Data20 = dr.IsDBNull(20) ? default : (decimal)dr[20];
            string Data21 = dr.IsDBNull(21) ? default : (string)dr[21];
            string Data22 = dr.IsDBNull(22) ? default : (string)dr[22];
            byte[] Data23 = dr.IsDBNull(23) ? default : (byte[])dr[23];
            byte[] Data24 = dr.IsDBNull(24) ? default : (byte[])dr[24];
            Guid Data25 = dr.IsDBNull(25) ? default : (Guid)dr[25];
            Guid? Data26 = dr.IsDBNull(26) ? default : (Guid)dr[26];
            DateTime Data27 = dr.IsDBNull(27) ? default : (DateTime)dr[27];
            DateTime? Data28 = dr.IsDBNull(28) ? default : (DateTime)dr[28];
            long _Data29 = dr.IsDBNull(29) ? default : (long)dr[29];
            Data29 Data29 = (Data29)_Data29;
            long? _Data30 = dr.IsDBNull(30) ? default : (long)dr[30];
